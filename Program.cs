...
static void Main()
{
    ...
    Console.WriteLine("¬ведите длину одномерного массива:");
    ...
    Console.WriteLine("¬ведите высоту массива");
    int high_d2 = int.Parse(Console.ReadLine());

    Console.WriteLine("¬ведите длину массивов");
